...
private fun MainActivity.buildMayagramAutoPostSettingsCard(parent: LinearLayout): () -> Unit {
    ...
    content.addView(hintText("Test amaçlı 1 dakika gibi küçük değerler girilebilir — gerçek kullanımda Local Dream'i sürekli açık tutmamak için daha uzun bir aralık (60-360 dakika) önerilir."))
    ...
    content.addView(dailyLimitEdit)
